        ...
        {items.map((item, idx) => {
          ...
          return (
            <button
              ...
              className="relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all text-white/50 hover:text-white/80 hover:bg-white/5 text-left"
            >
              {content}
            </button>
          );
