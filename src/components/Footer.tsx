      ...
      <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-lg font-heading font-bold text-foreground">CRAVI<span className="text-gradient">X</span></span>
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed">Crave it, order it, enjoy it. Delivering happiness to your doorstep.</p>
        </div>
        <div>
          <h4 className="mb-3 text-sm font-heading font-bold text-foreground">Company</h4>
        ...
        <div>
          <h4 className="mb-3 text-sm font-heading font-bold text-foreground">Support</h4>
          <div className="flex flex-col gap-2.5 text-sm text-muted-foreground">
        ...
        <div>
          <h4 className="mb-3 text-sm font-heading font-bold text-foreground">Legal</h4>
          <div className="flex flex-col gap-2.5 text-sm text-muted-foreground">
