      ...
      <div className="overflow-hidden rounded-2xl border bg-card/80 glass-card shadow-card transition-all hover:shadow-card-hover hover:neon-border">
        <div className="relative aspect-[16/10] overflow-hidden">
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-foreground/30 via-transparent to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
          {restaurant.featured && (
            <motion.span
        ...
        <div className="p-4">
          <div className="flex items-start justify-between gap-2">
            <h3 className="font-heading font-bold text-card-foreground line-clamp-1">{restaurant.name}</h3>
            <div className="flex shrink-0 items-center gap-1 rounded-full bg-accent/15 px-2.5 py-1">
              <Star className="h-3.5 w-3.5 fill-accent text-accent" />
              <span className="text-sm font-bold text-accent-foreground">{restaurant.rating}</span>
            </div>
          </div>
          ...
          <div className="mt-2.5 flex items-center gap-3 text-sm text-muted-foreground">
            <span className="flex items-center gap-1.5 rounded-full bg-secondary px-2.5 py-0.5">
