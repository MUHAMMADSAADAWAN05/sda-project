    ...
    <PageWrapper>
      <div className="container py-8">
        <motion.h1
          ...
          className="text-3xl font-heading font-extrabold mb-6 text-foreground"
        >
        ...
        >
          <div className="relative flex-1 max-w-md">
            ...
            <Input placeholder="Search restaurants or cuisines..." className="pl-10 rounded-xl glass-liquid neon-border-teal transition-all focus:neon-border text-foreground placeholder:text-muted-foreground" value={query} onChange={e => setQuery(e.target.value)} />
          </div>
          <div className="flex gap-2">
            <Select value={selectedCategory} onValueChange={setSelectedCategory}>
              <SelectTrigger className="w-[140px] rounded-xl glass-liquid neon-border-teal text-foreground"><SelectValue placeholder="Category" /></SelectTrigger>
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="w-[150px] rounded-xl glass-liquid neon-border-teal text-foreground"><SelectValue placeholder="Sort by" /></SelectTrigger>
              <SelectContent className="glass-strong rounded-xl border-white/10">
        ...
        {filtered.length === 0 ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-20 text-center">
            ...
            <p className="text-xl font-heading font-bold text-foreground">No restaurants found</p>
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="mt-6 text-sm text-muted-foreground glass-liquid inline-block rounded-full px-4 py-2 neon-border-teal">
