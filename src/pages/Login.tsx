    ...
    <PageWrapper>
      <div className="relative flex min-h-[80vh] items-center justify-center px-4">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -left-40 top-1/4 h-80 w-80 rounded-full bg-primary/8 blur-[120px]" />
          <div className="absolute -right-40 bottom-1/4 h-80 w-80 rounded-full bg-accent/8 blur-[120px]" />
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <Button variant="link" size="sm" className="h-auto p-0 text-xs text-primary">Forgot password?</Button>
              </div>
              <div className="relative">
