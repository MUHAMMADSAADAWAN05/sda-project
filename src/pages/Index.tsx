...
=======
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.2 }}
>>>>>>> 9ff8e9ec60d7bfcd236ee7588f3d2e9a4fc2ba55
...
=======
              <motion.form onSubmit={handleSearch} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.3 }}
>>>>>>> 9ff8e9ec60d7bfcd236ee7588f3d2e9a4fc2ba55
...
<<<<<<< HEAD
        ...
        <section className="container py-12">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-2xl font-heading font-bold mb-6 text-foreground"
          >
            Explore Categories
          </motion.h2>
          <motion.div
...
=======
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">{featured.map((r, i) => <RestaurantCard key={r.id} restaurant={r} index={i} />)}</div>
        </section>
...
=======
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">{topRated.slice(0, 6).map((r, i) => <RestaurantCard key={r.id} restaurant={r} index={i} />)}</div>
        </section>

        {/* CTA Banner */}
        <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="relative overflow-hidden">
          <div className="gradient-warm relative">
            <div className="absolute inset-0 bg-[linear-gradient(hsl(0_0%_100%/0.05)_1px,transparent_1px),linear-gradient(90deg,hsl(0_0%_100%/0.05)_1px,transparent_1px)] bg-[size:40px_40px]" />
            <div className="container relative py-16 text-center">
              <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-3xl font-heading font-bold text-primary-foreground md:text-4xl">
                Own a restaurant? Partner with CraviX
              </motion.h2>
              <p className="mt-3 text-primary-foreground/80 text-lg">Reach thousands of new customers and grow your business</p>
